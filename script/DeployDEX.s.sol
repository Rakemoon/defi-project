...
import {ZuzCoin} from "../src/ZuzCoin.sol";
import {MockUSDC} from "../src/MockUSDC.sol";
import {SimpleDEX} from "../src/SimpleDEX.sol";

contract DeployDEX is Script {
    // Contract instances
    ZuzCoin public campusCoin;
    ...
    function run() public returns (address, address, address) {
        ...
        campusCoin = new ZuzCoin();
        console.log("ZuzCoin deployed at:", address(campusCoin));
    ...
    function _printInstructions() internal view {
        ...
        console.log("ZuzCoin:", address(campusCoin));
